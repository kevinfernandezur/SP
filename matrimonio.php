...
<head>
    ...
    <link rel="stylesheet" href="matrimonio.css">
    <title>Matrimonio</title>
</head>
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-3 p-0" style="width: 20vw;">
                <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark p-0" style="width: 320px; height:100vh; background-color: #3350FF !important;">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li class="nav-item"> 
                            <a href="bautismo.php" class="nav-link text-white btnhover" style="font-size: 18px;">
            ...
            <div class="col-9">
                <table class="table mt-3" style="width: 70vw; margin-left: 50px;">
                    <thead class="bg-dark tabla" style="background-color: #B41111 !important;">
                        ...
                        <th scope="col">Cedula Esposo</th>
                        <th scope="col">Nombre Esposa</th>
                        <th scope="col">Cedula Esposa</th>
                        <th scope="col">Fecha Matrimonio</th>
                        <th scope="col">Nombre Sacerdote</th>
                        <th></th>
                        <th><a href="agregarmatrimonio.php" class="boton"><img src="agregar-usuario.png" alt="" class="icono-2"></a></th>
                        <th></th>
                        <th></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
                           $tabla = "SELECT * FROM `tbl_matrimonio`";
                        ...
                        ?>
                            ...
                            <td><?php echo $row['cedula_esposo'] ?></td>
                            <td><?php echo $row['nombre_esposa'] ?></td>
                            <td><?php echo $row['cedula_esposa'] ?></td>
                            <td><?php echo $row['fecha_casamiento'] ?></td>
                            <td><?php echo $row['nombre_reverendo'] ?></td>
                            <td><a href="editmatrimonio.php?Id_mat=<?php echo $row['Id_mat'] ?>" class="boton"><img src="editar-codigo.png" alt="" class="icono-2"></a></td>
                            <td><a href="deletematrimonio.php?Id_mat=<?php echo $row['Id_mat'] ?>" class="boton" onclick="confirmDelete(event, '<?php echo $row['Id_mat']?>')"><img src="boton-eliminar.png" alt="" class="icono-2"></a></td>
                            <td><a href="templatematrimonio.php?Id_mat=<?php echo $row['Id_mat'] ?>" class="boton"><img src="documento.png" alt="" class="icono-2"></a></td>
                            </tr>
                        <?php
                            }
                        ?>
...
<script>
function confirmDelete(event, Id_mat) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      window.location.href = 'deletematrimonio.php?Id_mat=' + Id_mat;
    }
  });
}
</script>
