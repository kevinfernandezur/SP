            ...
            <div class="col-9">
                <table class="table mt-3" style="width: 70vw; margin-left: 50px;">
                    <thead class="bg-dark tabla" style="background-color: #B41111 !important;">
                        ...
                        <th scope="col">Apellido Sacerdote</th>
                        <th scope="col">Direccion Sacerdote</th>
                        <th scope="col">Fecha Nacimiento Sacerdote</th>
                        <th scope="col">Telefono Sacerdote</th>
                        <th><a href="agregarsacerdote.php" class="boton"><img src="agregar-usuario.png" alt="" class="icono-2"></a></th>
                        <th></th>
                        <th></th>
                        <th></th>
                        </tr>
                    ...
                    <?php
                        ...
                        ?>
                            <tr>
                            <td><?php echo $row['Id_sac']?></td>
                            <td><?php echo $row['nombre_sac'] ?></td>
                            <td><?php echo $row['apellido_sac'] ?></td>
                            <td><?php echo $row['direccion_sac'] ?></td>
                            <td><?php echo $row['fecha_nac_sac'] ?></td>
                            <td><?php echo $row['telefono_sac'] ?></td>
                            <td><a href="editsacerdote.php?Id_sac=<?php echo $row['Id_sac'] ?>" class="boton"><img src="editar-codigo.png" alt="" class="icono-2"></a></td>
                            <td><a href="deletesacerdote.php?Id_sac=<?php echo $row['Id_sac'] ?>" class="boton" onclick="confirmDelete(event, '<?php echo $row['Id_sac']?>')"><img src="boton-eliminar.png" alt="" class="icono-2"></a></td>
                            </tr>
                        <?php
                            }
                        ?>
...
<script>
function confirmDelete(event, Id_sac) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      window.location.href = 'deletesacerdote.php?Id_sac=' + Id_sac;
    }
  });
}
</script>
